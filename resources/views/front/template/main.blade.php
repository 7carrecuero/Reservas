...
<html>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">@yield('modulo')</h2>
					<p>@yield('title')<b>@yield('funcion')</b></p>
				</div>
			</div>
			<div class="row">
	...
	<div class="gtco-cover gtco-cover-sm" style="background-image: url({{ asset('images/img_bg_1.jpg') }})"  data-stellar-background-ratio="0.5">
	...
	<footer id="gtco-footer" role="contentinfo" style="background-image: url({{ asset('images/img_bg_1.jpg')}})" data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="gtco-container">
